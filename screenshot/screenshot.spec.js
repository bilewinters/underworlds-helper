...
const screenshotsDirectory = path.resolve(path.join(root, 'marketing/screenshots'));
const imagesDirectory = path.resolve(path.join(screenshotsDirectory, device));
const imagePath = imageName => path.resolve(path.join(imagesDirectory, imageName));
...
test('Perform Screenshots', async () => {
